    ...
    var initClass = function (config) {
        ...
        function purgeStrings () {
            ...
            var sql = "DELETE FROM strings"
                ...
                + "   (SELECT rubricID AS stringID FROM questions"
        ...
        function openDatabase (callback) {
           ...
           db.exec(
                "CREATE TABLE IF NOT EXISTS admin (name TEXT,adminID TEXT, role INTEGER, interval INTEGER);"
                   ...
                   + "CREATE TABLE IF NOT EXISTS comments (commentID INTEGER PRIMARY KEY, classID INTEGER, quizNumber INTEGER, questionNumber INTEGER, choice INTEGER, commentTextID INTEGER);"
           );
            purgeStrings();
