(function () {
    var initClass = function (config) {
        ...
        function showUrl () {
            db.all('SELECT name,adminID FROM admin WHERE name=?',['admin'],function(err,rows){
        ...
        eventEmitter.on('showUrl',showUrl);
        ...
        function openDatabase (callback) {
           ...
           db.exec(
                "CREATE TABLE IF NOT EXISTS admin (name TEXT,adminID TEXT, role INTEGER);"
                   + "CREATE TABLE IF NOT EXISTS students (studentID INTEGER PRIMARY KEY,name TEXT,email TEXT);"
