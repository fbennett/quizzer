    ...
    utilClass.prototype.getUtils = function () {
        ...
        return {
            writeQuestion: function (response,classID,quizNumber,questionNumber,data) {
                ...
                console.log("WRITING WITH: classID="+classID+", quizNumber="+quizNumber+", questionNumber="+questionNumber);
                sys.db.get(sql,[classID,quizNumber,questionNumber],function(err,row) {
                    ...
                    if (row && row.quizID) {
                        ...
                        console.log("DATA QUESITON NUMBER IS NOW: "+data.questionNumber);
                        confirmStrings();
                    } else {
                    ...
                    console.log("SENDING RESPONSE AS: "+data.questionNumber);
